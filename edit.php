...
$query = "SELECT * FROM data_barang WHERE id_barang='" . $_GET['id_barang'] . "'";
            ...
            <div class="col-md-12"> 
                <form action="edit_process.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="harga_barang" class="form-control" value="<?php echo $customer["harga_barang"] ?>" required> 
                    </div> 
                    <div class="form-group">
